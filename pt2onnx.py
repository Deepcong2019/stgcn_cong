...
# 检测是否成功
import  onnx
onnx_model = onnx.load('stgcn.onnx')
...
# 查看output shape
import onnx
onnx_graph = onnx.load('stgcn.onnx')
estimated_graph = onnx.shape_inference.infer_shapes(onnx_graph)
onnx.save(estimated_graph, 'stgcn_shape.onnx')



# 转engine
# 进入tensorrt的安装目录，bin：cd C:\Program Files\TensorRT-8.6.1.6\bin
# 执行.\trtexec.exe --onnx=F:\pyspace\st-gcn\stgcn.onnx --saveEngine=F:\pyspace\st-gcn\stgcn.engine
